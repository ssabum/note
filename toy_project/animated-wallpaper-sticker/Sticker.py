...
if __name__ == '__main__':
    ...
    s1 = Sticker('gif/amongus/red_vent.gif', xy=[600, 25], size=0.165, on_top=True)

    s2 = Sticker('gif/amongus/orange.gif', xy=[1800, 90], size=0.165, on_top=True)

    s3 = Sticker('gif/amongus/blue_green.gif', xy=[70, 900], size=0.6, on_top=True)

    s4 = Sticker('gif/amongus/mint.gif', xy=[800, 900], size=0.17, on_top=True)
    s4.walk_diff(from_xy_diff=[-100, 0], to_xy_diff=[100, 0], speed=120)

    s5 = Sticker('gif/amongus/brown.gif', xy=[500, 0], size=0.265, on_top=True)

    s6 = Sticker('gif/amongus/yellow.gif', xy=[1810, 900], size=0.225, on_top=True)
    # s6.walk(from_xy=[0, 800], to_xy=[1850, 800], speed=240)

    # s7 = Sticker('gif/amongus/magenta.gif', xy=[1600, 890], size=0.3, on_top=True)
